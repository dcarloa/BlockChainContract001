# Script con datos de ejemplo precargados (para demos)
# Este script despliega TravelFundV2 con Alice, Bob, Charlie y Diana ya configurados

Write-Host ""
Write-Host "=======================================" -ForegroundColor Cyan
Write-Host "  TravelFund V2 - Demo con Datos" -ForegroundColor Cyan
Write-Host "=======================================" -ForegroundColor Cyan
Write-Host ""
...
# Desplegar contrato V2 CON DATOS DE EJEMPLO
Write-Host "Desplegando TravelFundV2 (con datos de ejemplo)..." -ForegroundColor Yellow
Write-Host ""
...
Write-Host "[OK] TravelFundV2 desplegado con datos de ejemplo" -ForegroundColor Green
Write-Host "======================================="-ForegroundColor Green
Write-Host ""
...
Write-Host ""
Write-Host "[DEMO] Datos precargados:" -ForegroundColor Yellow
Write-Host "   - Fondo: Viaje a Cancun 2025" -ForegroundColor White
Write-Host "   - Usuarios: Alice, Bob, Charlie, Diana" -ForegroundColor White
Write-Host "   - Balance: 9 ETH depositados" -ForegroundColor White
Write-Host "   - Propuestas: 2 activas" -ForegroundColor White
Write-Host ""
...
Write-Host ""
Write-Host "[CUENTA] Alice (Creadora):" -ForegroundColor Yellow
...
Write-Host ""
Write-Host "[CUENTA] Bob:" -ForegroundColor Yellow

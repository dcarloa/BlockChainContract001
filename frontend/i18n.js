...
const translations = {
    en: {
        ...
        landing: {
            ...
            howItWorks: {
                title: "How it works",
                subtitle: "No spreadsheets. No stress.",
                threeSteps: "",
                step1: {
                    title: "1️⃣ Create a group",
                    desc: "Name it, add members, done."
                },
                step2: {
                    title: "2️⃣ Add expenses",
                    desc: "Track what everyone spends."
                },
                step3: {
                    title: "3️⃣ See balances instantly",
                    desc: "Know who owes who, in real time."
                }
            },
            whereAnts: {
            ...
            cta: {
                title: "Stop arguing about money.",
                subtitle: "Start enjoying your plans again.",
                button: "Create your first group — Free",
                noRegistration: "No apps to download • Works everywhere • 100% free"
            },
            footer: {
        ...
        app: {
            ...
            fundDetail: {
                ...
                mascot: {
                    ...
                    chestClaimed: "Chest Already Claimed",
                    ...
                    guide: {
                        ...
                        silver: "⭐⭐ Silver:",
                        silverDesc: "3 copies obtained (upgraded!)",
                        gold: "⭐⭐⭐ Gold:",
                        goldDesc: "6 copies obtained (max level!)",
                        collection: "🎒 Complete Collection",
                        collectionDesc: "There are 12 unique items to collect: 6 for the head slot and 6 for the accessory slot. You can equip one item in each slot to customize your group's ant mascot.",
                        tips: "💡 Tips",
    ...
    es: {
        ...
        landing: {
            ...
            howItWorks: {
                title: "Cómo funciona",
                subtitle: "Sin hojas de cálculo. Sin estrés.",
                threeSteps: "",
                step1: {
                    title: "1️⃣ Crear un grupo",
                    desc: "Nómbralo, agrega miembros, listo."
                },
                step2: {
                    title: "2️⃣ Agregar gastos",
                    desc: "Rastrea lo que todos gastan."
                },
                step3: {
                    title: "3️⃣ Ver balances al instante",
                    desc: "Sabe quién debe a quién, en tiempo real."
                }
            },
            whereAnts: {
            ...
            cta: {
                title: "Deja de discutir por dinero.",
                subtitle: "Comienza a disfrutar tus planes de nuevo.",
                button: "Crea tu primer grupo — Gratis",
                noRegistration: "Sin apps que descargar • Funciona en todos lados • 100% gratis"
            },
            footer: {
        ...
        app: {
            ...
            fundDetail: {
                ...
                mascot: {
                    ...
                    chestClaimed: "Cofre Ya Reclamado",
                    ...
                    guide: {
                        ...
                        silver: "⭐⭐ Plata:",
                        silverDesc: "3 copias obtenidas (¡mejorado!)",
                        gold: "⭐⭐⭐ Oro:",
                        goldDesc: "6 copias obtenidas (¡nivel máximo!)",
                        collection: "🎒 Colección Completa",
                        collectionDesc: "Hay 12 prendas únicas para coleccionar: 6 para la ranura de cabeza y 6 para la ranura de accesorio. Puedes equipar una prenda en cada ranura para personalizar la hormiga mascota de tu grupo.",
                        tips: "💡 Consejos",
